...
export default function AreaPreview({ bounds }: AreaPreviewProps) {
  ...
  return (
    <div className="rounded-lg border border-neutral-800 bg-gradient-to-br from-neutral-900/80 to-neutral-900/50 backdrop-blur p-6 space-y-4 shadow-lg transition-all hover:border-neutral-700 hover:shadow-xl">
      <div>
        <h3 className="text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-4">Area Size</h3>
        <div className="space-y-3 text-sm">
          <div className="flex justify-between items-center group">
            <span className="text-neutral-500 group-hover:text-neutral-400 transition-colors">Width</span>
            <span className="font-mono text-neutral-200 font-medium">
              {(width / 1000).toFixed(2)} km
            </span>
          </div>
          <div className="flex justify-between items-center group">
            <span className="text-neutral-500 group-hover:text-neutral-400 transition-colors">Height</span>
            <span className="font-mono text-neutral-200 font-medium">
          ...
          <div className="flex justify-between items-center group">
            <span className="text-neutral-400 font-medium group-hover:text-neutral-300 transition-colors">Total Area</span>
